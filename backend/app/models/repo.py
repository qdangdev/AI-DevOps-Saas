...
class Repo(Base):
    ...
    # GitHub metadata snapshot. Source of truth is GitHub; we cache for fast list views.
    github_repo_id: Mapped[int] = mapped_column(BigInteger, nullable=False)
    full_name: Mapped[str] = mapped_column(String(512), nullable=False)  # "octocat/hello-world"
